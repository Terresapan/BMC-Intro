...
import { PieDataPoint, SensitivityPoint } from '@/app/cost-simulator/types';
            ...
            <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                    ...
                    <RechartsTooltip 
                        ...
                        contentStyle={{ 
                            backgroundColor: '#0f0720', // brand-dark
                            borderColor: '#1e293b', 
                            borderRadius: '12px', 
                            color: '#f1f5f9',
        ...
        <div className="w-full h-48">
            <ResponsiveContainer width="100%" height="100%">
                ...
                >
                    ...
                    />
                    <Tooltip 
                        formatter={(value: number | undefined) => [`$${(value || 0).toFixed(0)}`, 'Monthly Cost']}
